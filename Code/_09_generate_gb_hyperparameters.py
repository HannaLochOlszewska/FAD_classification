...
"""
Randomised search for gradient boosting hyperparameters.
"""

def search_hyperparameters(simulation_folder, test_version=''):
    """
    Function for searching best hyperparameters for gradient boosting algorithm
    ...
    path_to_hyperparameters = os.path.join(project_directory, "Models", "GB", simulation_folder, 'Model' + test_version)
